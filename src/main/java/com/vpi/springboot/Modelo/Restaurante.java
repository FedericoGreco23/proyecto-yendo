...
public class Restaurante extends Usuario{
	...
	public Restaurante(String mail, String contrasenia, String telefono, String foto, 
			Boolean bloqueado, Boolean activo, String nombre, 
			String direccion, Float calificacionPromedio, /*EnumEstadoRestaurante estado,*/ 
			LocalTime horarioApertura, LocalTime horarioCierre, LocalTime tiempoEstimadoMinimo,
			LocalTime tiempoEstimadoMaximo, Date fechaApertura, Integer costoDeEnvio) {

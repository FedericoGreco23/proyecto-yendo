...
public interface AdministradorServicioInterfaz {
	...
	public Map<String, Object> buscarUsuario(int page, int size, int tipoUsuario, Integer antiguedadUsuario, String nombreUsuario, String sort, int order, int estado);
